...
const Employees = () => {
  ...
  // NEW: State to handle the details view modal
          ...
          {employees.map((emp) => (
            <tr key={emp.id_employee} className="border-b hover:bg-gray-50">
              ...
              <td className="p-3 text-right space-x-2">
                {/* NEW: Details button added here */}
                <button onClick={() => setViewingEmployee(emp)} className="bg-blue-500 text-white px-3 py-1 rounded text-sm hover:bg-blue-600">Дет.</button>
